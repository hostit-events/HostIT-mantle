...
export const useRemoveTicketAdmins = () => {
    ...
    async (ticketId: number, admins: `0x${string}`[]) => {
      ...
      try {
        ...
        const hash = await walletClient.writeContract({
          ...
          functionName: "removeTicketAdmins",
        ...
        console.error("Error removing ticket Admin:", error);
        toast.error(error?.message || "Failed to remove ticket admins");
      }
    },
